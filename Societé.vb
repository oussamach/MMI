...
Public Class Societé
    ...
    Public Sub Societe()
        Dim Societe = "select * from Societe"
        da1 = New SqlDataAdapter(Societe, con)
        If ds.Tables.Contains("Societe") Then
            ds.Tables("Societe").Rows.Clear()
        End If
        con.Open()
        da1.Fill(ds, "Societe")
        con.Close()
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            If TextBox2.Text = "" Then
                MsgBox("Remplir le champs de nom de societe", MsgBoxStyle.Information, "Information")
            Else
                dr1 = dt.NewRow
                dr1(1) = TextBox2.Text
                cb = New SqlCommandBuilder(da1)
                dt.Rows.Add(dr1)
                da1.Update(ds, "Societe")
                MsgBox("Societe Ajouter", MsgBoxStyle.Information, "Information")
            ...
            Else
                ...
                For c = 0 To dt.Rows.Count - 1
                    If TextBox1.Text = dt.Rows(c)(0) Then
                        ...
                        cb = New SqlCommandBuilder(da1)
                        da1.Update(ds, "Societe")
                        MsgBox("Societe Modifier", MsgBoxStyle.Information, "Information")
                        pos = True
                    End If
                Next
                If pos = False Then
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        Try
            If MsgBox("Voulez-vous vraiment supprimer cette Société?", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
                If dt.Rows.Count <> 0 Then
                    dt.Rows(i).Delete()
                    ...
                    nouveau()
                    navigation(0)
                    MsgBox("La Societe  à été supprimer avec Sucée", MsgBoxStyle.Information, "Information")
                    Label4.Text = (i + 1) & "/" & dt.Rows.Count
                Else
